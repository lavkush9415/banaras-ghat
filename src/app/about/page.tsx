...
export const metadata: Metadata = {
  title: 'About Us | Varanasi Heritage Tour & Travels — Your Varanasi Travel Partner',
  description: 'Learn about Varanasi Heritage Tour & Travels — a decade of curating authentic, spiritual, and luxury travel experiences in the sacred city of Varanasi.',
}

const team = [
  { name: 'Vikas Yadav', role: 'Founder & CEO', image: '/vikas.jpeg', exp: '15 Years' },
        ...
        <div className="container-custom">
          <FadeIn className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-gray-500 text-lg leading-relaxed">
              Born from a deep love for Banaras and its timeless soul, Varanasi Heritage Tour & Travels was founded with one mission: to share the magic of Varanasi with the world — authentically, responsibly, and beautifully.
            </p>
          </FadeIn>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <FadeIn direction="right">
              ...
              <p className="text-gray-500 leading-relaxed mb-4">
                Founded in 2014 by Vikas Kumar Yadav — a native Banarasi and passionate travel enthusiast — Varanasi Heritage Tour & Travels started as a small boat tour service at Dashashwamedh Ghat. What began with two boats and a dream has grown into Varanasi&apos;s most trusted multi-service travel company.
              </p>
